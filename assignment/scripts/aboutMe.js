...
let fullName = firstName +' '+ lastName; // isn't there a way to do it without adding empty space manually?
...
if( pets == friendsPets){
  console.log("my pets and friend's pets are the same number!!");
  mostPets = pets;
}
...
let expr1 = "Adventures are great!";
let expr2 = "How about we stay home?";
let ternaryResult = adventurous == true ? expr1 : expr2;
